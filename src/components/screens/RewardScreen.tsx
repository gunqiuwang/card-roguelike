...
export function RewardScreen() {
  ...
  return (
    <div className="relative min-h-screen bg-ink text-parchment flex flex-col items-center justify-center px-6 py-10">
      ...
      <div className="relative z-10 max-w-3xl w-full text-center">
        ...
        <h1 className="font-heading text-parchment-light text-3xl tracking-widest mb-6">
          三 取 其 一
        </h1>
        ...
        <div className="flex gap-6 justify-center flex-wrap mb-10">
          {rew.cardChoices.map((c, i) => (
            <div key={`${c.id}-${i}`} className="flex flex-col items-center gap-3">
              <Card card={cardToInstance(c)} width={180} interactive />
